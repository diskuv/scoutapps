...
usage() {
  ...
  echo "  GIT_TAG_DKSDK_CMAKE - Git <tag> or <remote>/<branch> for dksdk-cmake"
  echo "  GIT_TAG_DKSDK_OPAM_REPOSITORY - Git <tag> or <remote>/<branch> for dksdk-opam-repository"
  echo "  GIT_TAG_DKSDK_OPAM_REPOSITORY_JS - Git <tag> or <remote>/<branch> for dksdk-opam-repository-js"
  echo "  GIT_TAG_DKML_RUNTIME_COMMON - Git <tag> or <remote>/<branch> for github.com/diskuv/dkml-runtime-common"
  echo "  GIT_TAG_DKML_RUNTIME_DISTRIBUTION - Git <tag> or <remote>/<branch> for github.com/diskuv/dkml-runtime-distribution"
  echo "  GIT_TAG_DKML_COMPILER - Git <tag> or <remote>/<branch> for github.com/diskuv/dkml-compiler"
  echo "  GIT_TAG_OPAM_OVERLAYS - Git <tag> or <remote>/<branch> for github.com/dune-universe/opam-overlays.git"
  echo "  GIT_TAG_OPAM_REPOSITORY - Git <tag> or <remote>/<branch> for github.com/ocaml/opam-repository.git"
  echo "  GIT_URL_DKSDK_CMAKE - Git url for dksdk-cmake"
  echo "  GIT_URL_* - Git url for all the GIT_TAG_* above"
  exit 2
}
pin=
latest=0
...
clone https://github.com/diskuv/dkml-runtime-distribution.git dkml-runtime-distribution
clone https://github.com/diskuv/dkml-compiler.git             dkml-compiler
clone https://github.com/dune-universe/opam-overlays.git      opam-overlays
clone https://github.com/ocaml/opam-repository.git            opam-repository
