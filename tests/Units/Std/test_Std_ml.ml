...
let () =
  ...
  let result_strings =
    ( SquirrelScout_Std.Db_utils.return_code_to_string a,
      SquirrelScout_Std.Db_utils.return_code_to_string b,
      SquirrelScout_Std.Db_utils.return_code_to_string c )
  in
